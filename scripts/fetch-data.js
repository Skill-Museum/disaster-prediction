...
// Dense grid for live rain radar overlay (30+ points covering all of Nepal) — all coords verified inside Nepal polygon
const LIVE_RAIN_GRID = [
  // Western Nepal (Karnali) — Terai points matched to actual Nepal-India border latitude
  { lat:29.40, lon:80.75, name:'Far-West Mountains' },
  { lat:28.90, lon:81.20, name:'Far-West Hills' },
  { lat:29.07, lon:80.98, name:'Doti' },
  { lat:28.45, lon:81.30, name:'Far-West Terai' },
  { lat:29.55, lon:82.08, name:'Mugu' },
  { lat:29.27, lon:82.18, name:'Jumla' },
  { lat:28.38, lon:82.16, name:'Salyan' },
  { lat:28.15, lon:81.85, name:'Karnali Terai' },
  // Mid-Western (Bheri/Rapti)
  { lat:28.94, lon:82.82, name:'Dolpa' },
  { lat:28.60, lon:82.88, name:'Karnali Hills' },
  { lat:28.08, lon:82.86, name:'Pyuthan' },
  { lat:28.00, lon:82.45, name:'Bheri Hills' },
  { lat:28.15, lon:81.90, name:'Banke Terai' },
  // Central (Narayani/Trishuli)
  { lat:28.85, lon:83.73, name:'Mustang' },
  { lat:28.62, lon:82.64, name:'Rukum' },
  { lat:28.05, lon:82.55, name:'Dang' },
  { lat:27.90, lon:82.70, name:'Rapti Terai' },
  { lat:27.58, lon:84.35, name:'Chitwan Terai' },
  { lat:27.95, lon:84.42, name:'Bandipur' },
  { lat:28.50, lon:84.70, name:'Manaslu' },
  { lat:28.60, lon:83.82, name:'Annapurna' },
  // Kathmandu Valley + surround
  { lat:27.71, lon:85.32, name:'Kathmandu Valley' },
  { lat:27.64, lon:85.52, name:'Kavre' },
  { lat:28.05, lon:85.10, name:'Nuwakot' },
  { lat:28.18, lon:85.35, name:'Rasuwa' },
  { lat:28.21, lon:85.55, name:'Langtang' },
  // Sunkoshi corridor
  { lat:27.25, lon:85.90, name:'Sindhuli' },
  { lat:27.70, lon:86.05, name:'Ramechhap' },
  { lat:27.66, lon:86.08, name:'Dolakha' },
  { lat:27.96, lon:86.34, name:'Gaurishankar' },
  { lat:27.45, lon:86.42, name:'Khimti' },
  // East-Central (Koshi)
  { lat:26.80, lon:87.10, name:'Sunsari Terai' },
  { lat:27.35, lon:87.20, name:'Koshi Hills' },
  { lat:27.55, lon:86.73, name:'Solukhumbu' },
  { lat:27.98, lon:86.92, name:'Everest Region' },
  { lat:27.32, lon:86.50, name:'Okhaldhunga' },
  // Far-East (Mechi)
  { lat:26.65, lon:87.92, name:'Jhapa Terai' },
  { lat:27.05, lon:87.92, name:'Ilam Hills' },
  { lat:27.35, lon:87.85, name:'Taplejung' },
  { lat:27.70, lon:88.08, name:'Kanchenjunga' },
  { lat:26.65, lon:88.05, name:'Mechi Terai' },
];
